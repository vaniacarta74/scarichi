    ...
    public function scarichiProvider() : array
    {
        ...
        $data = [
            ...
            'full 0' => [
                ...
                'nozero' => 'TRUE',
                'campo' => '',
                'expected' => $header . PHP_EOL . '1) PID 0: Elaborazione dati Volume variabile 30030 dal 01/01/2019 al 02/01/2019 avvenuta con successo in | sec. Nessun file CSV senza zeri esportato per mancanza di dati. (tocsv@' . REALHOST . ')' . PHP_EOL
            ],
            'full 1' => [
                'help' => null,
                'version' => null,
